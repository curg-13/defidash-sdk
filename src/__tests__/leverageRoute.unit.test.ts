/**
 * Unit Tests: findBestLeverageRoute (extracted module)
 *
 * Tests the standalone findBestLeverageRoute function with mocked dependencies.
 * No mainnet RPC required.
 *
 * Run: npx vitest run src/__tests__/leverageRoute.unit.test.ts
 */
